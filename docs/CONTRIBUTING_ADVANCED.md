...
- [Contributing - Advanced](#contributing---advanced)
  ...
  - [Building and Running Vimtype](#building-and-running-vimtype)
...
1. [Create a new Firebase project.](https://console.firebase.google.com/u/0/)
   ...
   - The project name doesn't matter, but the name `vimtype` would be preferred.
...
3. (Optional) Install [MongoDB-compass](https://www.mongodb.com/try/download/compass?tck=docs_compass). This tool can be used to see and manipulate your database visually.
   - To connect, type `mongodb://localhost:27017` in the connection string box and press connect. The Vimtype database will be created and shown after the server is started.

## Building and Running Vimtype

It's time to run Vimtype. Just like with the databases, you can run the frontend and backend manually or with Docker.
...
Code formatting is enforced by `oxfmt`, which automatically runs every time you make a commit.
...
For guidelines on commit messages and contribution expectations, please refer to [CONTRIBUTING.md](./CONTRIBUTING.md). Following these guidelines will increase the chances of getting your change accepted.
